// var slack = require('./src/helpers/slack-integration');
exports.config = {
    //
    // ====================
    ...
    afterSuite: function (suite) {
        console.log("++++++++++++++++++++++++++++");
        console.log("after suit hook");
        console.log(suit);
        console.log("++++++++++++++++++++++++++++");
    },
    after: function (result, capabilities, specs) {
        console.log("++++++++++++++++++++++++++++");
        console.log("after hook : after all test done");
        console.log(result);
    ...
    afterFeature: function (uri, feature) {
        console.log("++++++++++++++++++++++++++++");
        console.log("after feature : after featuire done");
        console.log(uri);
        console.log(feature);
        console.log("++++++++++++++++++++++++++++");
    },
    onComplete: function (exitCode, config, capabilities, results) {
        ...
        // console.log(capabilities);
        console.log(results);
        // slack.send_slack_update(results);


        const { IncomingWebhook } = require('@slack/webhook');
        const url = "https://hooks.slack.com/services/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";
        ...
        (async () => {
            await webhook.send({
              text: 'Execution Results\nTotal Tests Run:'+results.finished+'\nTotal Tests Passed:'+results.passed+'\nTotal Tests Failedd:'+results.failed
            });
          })();
        console.log("++++++++++++++++++++++++++++");
    },
